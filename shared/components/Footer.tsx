...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-[#020617] dark:to-[#0f172a] text-gray-900 dark:text-white py-12 px-4 font-sans border-t border-gray-200 dark:border-white/5 relative z-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="space-y-4">
          ...
          <div className="flex space-x-5 pt-2">
            <a
              href="#"
              className="text-gray-500 hover:text-blue-600 dark:text-slate-500 dark:hover:text-violet-400 transition-transform transform hover:scale-110"
            >
              <GitHubIcon size={24} />
            </a>
            <a
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            <li>
              <a
                href="#"
                className="text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-violet-400 transition-colors duration-300"
              >
                Home
              </a>
            </li>
      ...
      <div className="text-center text-gray-500 dark:text-slate-600 text-sm pt-10 mt-10 border-t border-gray-200 dark:border-white/5">
        <p>
          &copy; {new Date().getFullYear()} Repix.art. All rights reserved.
        </p>
        <p className="mt-1">
          Designed with <span className="text-red-500">&hearts;</span> by Repix Team
        </p>
      </div>
    </footer>
  );
