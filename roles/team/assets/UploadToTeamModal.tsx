...
interface UploadToTeamModalProps {
    onClose: () => void;
    isTeamUpload?: boolean; // Always true for team uploads
}

export const UploadToTeamModal = ({ onClose, isTeamUpload = true }: UploadToTeamModalProps) => {
                ...
                <div className="p-6 overflow-y-auto">
                    ...
                    <div className="mb-4">
                        ...
                        <select className="w-full px-3 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-lg text-sm transition-all focus:ring-2 focus:ring-blue-500">
                            <option value="">All Team Assets (Root)</option>
                            {MOCK_FOLDERS.filter(f => f.isShared).map(folder => (
