...
import { MOCK_FOLDERS } from './types';
...
export const TeamFolderSidebar = ({ activeFolderId, onSelectFolder, viewMode }: TeamFolderSidebarProps) => {
    // Only show shared folders for team assets
    const folders = MOCK_FOLDERS.filter(f => f.isShared);

    const activeClass = 'bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 font-medium';
            ...
            <div className="flex-1 overflow-y-auto px-2 space-y-1">
                ...
                {folders.map(folder => {
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-2">
                                <IconComponent className={`w-4 h-4 ${activeFolderId === folder.id ? 'fill-current' : ''}`} />
